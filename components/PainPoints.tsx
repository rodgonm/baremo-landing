      ...
      <div className="mx-auto max-w-[1400px] px-8 lg:px-12">
        ...
        <div className="mt-10 space-y-8">
          {statements.map((item, i) => (
            <p
              key={i}
              className="pain-statement max-w-[900px] font-display text-[clamp(1.5rem,3.2vw,2.5rem)] font-semibold leading-[1.25] tracking-[-0.02em] text-[#555]"
              style={{ opacity: 0 }}
            >
              {item.text}{" "}
        ...
        <div className="pain-resolve mt-20 flex items-center gap-4" style={{ opacity: 0 }}>
