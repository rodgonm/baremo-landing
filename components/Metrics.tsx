...
const metrics = [
  {
    ...
    sublabel: "Promedio por tienda",
  },
  {
    value: 100,
    suffix: "%",
    label: "Digital desde el día uno",
    sublabel: "Cero papel. Cero Excel.",
  },
  {
    value: 0,
    suffix: "",
    label: "Datos al instante",
    sublabel: "Sin esperar el reporte del viernes",
    display: "Real-time",
  },
];
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {metrics.map((m) => (
            <div key={m.label} className="metric-card" style={{ opacity: 0 }}>
              <p
                className="metric-value font-display text-[clamp(2.25rem,5vw,4.5rem)] font-extrabold leading-[0.9] tracking-[-0.04em]"
                data-value={m.value}
              ...
              <p className="mt-3 font-display text-[0.875rem] font-semibold text-text">
                {m.label}
              </p>
