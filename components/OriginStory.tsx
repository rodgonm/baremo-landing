    ...
    <section id="nosotros" className="bg-bg-dark py-36 lg:py-48">
      <div className="mx-auto max-w-[1400px] px-8 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:gap-16">
          ...
          <ScrollReveal>
            <div className="placeholder-media aspect-[4/5] overflow-hidden rounded-[16px]" style={{ background: '#141414' }}>
              <div className="flex h-full items-center justify-center px-6">
                <span className="text-center text-[0.6875rem] uppercase tracking-[0.15em] text-[#555]">
          ...
          <ScrollReveal delay={0.1}>
            <div className="flex flex-col justify-center lg:py-8">
              ...
              <div className="mt-8 space-y-5 text-[1rem] leading-[1.8] text-[#888]">
                <p>
